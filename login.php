...
$users = new User();
  ...
  if (isset($_POST['Login'])) {
        ...
        $validator1->add_field('username');
        $validator1->add_rule_to_field('username', array('empty'));

        $validator1->add_field('password');
        $validator1->add_rule_to_field('password', array('empty'));

               
     
        if (!$validator1->passed()){
